...
function serialize_MirrorRequest(arg) {
  if (!(arg instanceof daemon_drive_pb.MirrorRequest)) {
    throw new Error('Expected argument of type MirrorRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_MirrorRequest(buffer_arg) {
  return daemon_drive_pb.MirrorRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_MirrorResponse(arg) {
  if (!(arg instanceof daemon_drive_pb.MirrorResponse)) {
    throw new Error('Expected argument of type MirrorResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_MirrorResponse(buffer_arg) {
  return daemon_drive_pb.MirrorResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_UnmirrorRequest(arg) {
  if (!(arg instanceof daemon_drive_pb.UnmirrorRequest)) {
    throw new Error('Expected argument of type UnmirrorRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_UnmirrorRequest(buffer_arg) {
  return daemon_drive_pb.UnmirrorRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_UnmirrorResponse(arg) {
  if (!(arg instanceof daemon_drive_pb.UnmirrorResponse)) {
    throw new Error('Expected argument of type UnmirrorResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_UnmirrorResponse(buffer_arg) {
  return daemon_drive_pb.UnmirrorResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
version: {
  ...
  mirror: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: daemon_drive_pb.MirrorRequest,
    responseType: daemon_drive_pb.MirrorResponse,
    requestSerialize: serialize_MirrorRequest,
    requestDeserialize: deserialize_MirrorRequest,
    responseSerialize: serialize_MirrorResponse,
    responseDeserialize: deserialize_MirrorResponse,
  },
  unmirror: {
    path: '/Drive/unmirror',
    requestStream: false,
    responseStream: false,
    requestType: daemon_drive_pb.UnmirrorRequest,
    responseType: daemon_drive_pb.UnmirrorResponse,
    requestSerialize: serialize_UnmirrorRequest,
    requestDeserialize: deserialize_UnmirrorRequest,
    responseSerialize: serialize_UnmirrorResponse,
    responseDeserialize: deserialize_UnmirrorResponse,
  },
  read: {
    path: '/Drive/read',
    requestStream: true,
