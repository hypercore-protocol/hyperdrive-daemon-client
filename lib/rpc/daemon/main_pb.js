...
proto.StatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    holepunchable: jspb.Message.getBooleanFieldWithDefault(msg, 9, false),
    remoteaddress: jspb.Message.getFieldWithDefault(msg, 10, ""),
    fuseavailable: jspb.Message.getBooleanFieldWithDefault(msg, 11, false),
    fuseconfigured: jspb.Message.getBooleanFieldWithDefault(msg, 12, false),
