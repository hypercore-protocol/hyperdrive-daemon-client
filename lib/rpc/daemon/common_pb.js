...
proto.HyperdriveOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    seed: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
...
proto.NetworkConfiguration.toObject = function(includeInstance, msg) {
  var f, obj = {
    lookup: jspb.Message.getFieldWithDefault(msg, 1, false),
    announce: jspb.Message.getFieldWithDefault(msg, 2, false),
    remember: jspb.Message.getFieldWithDefault(msg, 3, false)
  };
